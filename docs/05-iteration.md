...
- **架构自我迭代由 CKO 管理**：CKO 掌握本架构仓库的 GitHub URL，负责架构文档 / 版本 / 工作流提炼的更新管理（见 [docs/02-boundaries.md](02-boundaries.md) §1.6）。
- 每迭代四步循环：**规划 → 执行 → 评审 → 复盘**。
...
- **架构自我迭代（由 CKO 管理）**：CKO 掌握本架构仓库的 GitHub URL，负责架构文档 / 版本 / 工作流提炼的更新管理（见 [docs/02-boundaries.md](02-boundaries.md) §1.6）。
