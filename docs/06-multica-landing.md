...
- **跟进 = 持续自我迭代**：跟进在 Multica 中表现为**持续自我迭代 agent 描述、维护上下文**；相关流程时间点记录为 **issue**（跟踪记录落于 issue，控制上下文不过度扩张）。
- **谁来唤醒谁**：
...
- **低频 autopilot**：**定期开启**，推进 **CKO 记录**（整理工作流 / skill / 红线手册 / 新闻快讯），然后**清理上下文**（收尾归档）。
